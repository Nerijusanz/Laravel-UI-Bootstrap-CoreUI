        ...
        <div class="card-body">
            <div class="d-flex justify-content-end mb-1">
                ...
                @can('role_management_delete')
                    <button type="submit" class="btn btn-sm btn-danger text-light float-end" onclick="if (confirm('{{ __('global.areYouSure') }}') == true){ event.preventDefault(); document.getElementById('form-role-delete').submit(); }">
