        ...
        <div class="card-body">
            <div class="d-flex justify-content-end mb-1">
                ...
                @can('user_management_delete')
                    <button type="submit" class="btn btn-sm btn-danger text-light float-end" onclick="if (confirm('{{ __('global.areYouSure') }}') == true){ event.preventDefault(); document.getElementById('form-user-delete').submit(); }">
                        <i class="fas fa-trash"></i>
                    </button>
                    <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST" id="form-user-delete" class="d-none">
